...
class SidesControllerTest < ActionController::TestCase
  ...
  test "should create side" do
    assert_difference('Side.count') do
      post :create, side: { is_winner: @side.is_winner, score: @side.score, team_id: @side.team_id, user_id: @side.user_id }
    end
  ...
  test "should update side" do
    patch :update, id: @side, side: { is_winner: @side.is_winner, score: @side.score, team_id: @side.team_id, user_id: @side.user_id }
    assert_redirected_to side_path(assigns(:side))
  end
